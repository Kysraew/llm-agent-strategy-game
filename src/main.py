...
def main():
  ...
  # Custom run
  # arena = Arena()
  # game_paths = ConfigManager.get_map_paths(ConfigManager.get_project_dir() / "src/game_configs/kill_the_king/small-5x5/")
  # game_path = ConfigManager.get_project_dir() / "src/game_configs/kill_the_king/small-5x5/mountains/king_warrior.yaml"
  # multiple_game_stats = arena.run_duel_on_many_maps(random_agent, attack_first_agent , [game_path], 1)
